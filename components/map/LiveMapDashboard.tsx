    ...
    return (
        <div className="relative h-full w-full bg-[#050505] overflow-hidden font-sans">
            ...
            <div className="absolute top-0 left-0 right-0 z-20 p-6 pt-16">
                <div className="max-w-md mx-auto bg-[#111111]/80 backdrop-blur-xl shadow-2xl border border-white/10 rounded-2xl p-4 flex items-center gap-4 transition-colors focus-within:border-emerald-500/50">
                ...
                {activeRide ? (
                    ...
                    >
                        ...
                        <div className="px-6 pb-10 space-y-8">
                            <div>
                                <h2 className="text-2xl font-bold tracking-tight text-white mb-1">Scrap Pickup</h2>
